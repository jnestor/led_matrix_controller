...
#set_property PACKAGE_PIN U9 [get_ports {num_color[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {num_color[0]}]
##Bank = 34, Pin name = IO_25_34,							Sch name = SW1
#set_property PACKAGE_PIN U8 [get_ports {num_color[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {num_color[1]}]
##Bank = 34, Pin name = IO_L23P_T3_34,						Sch name = SW2
#set_property PACKAGE_PIN R7 [get_ports {num_color[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {num_color[2]}]
...
#set_property PACKAGE_PIN T8 [get_ports {digit[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {digit[0]}]
##Bank = 34, Pin name = IO_L21N_T3_DQS_34,					Sch name = LED1
#set_property PACKAGE_PIN V9 [get_ports {digit[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {digit[1]}]
##Bank = 34, Pin name = IO_L24P_T3_34,						Sch name = LED2
#set_property PACKAGE_PIN R8 [get_ports {digit[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {digit[2]}]
##Bank = 34, Pin name = IO_L23N_T3_34,						Sch name = LED3
#set_property PACKAGE_PIN T6 [get_ports {digit[3]}]					
...
#set_property PACKAGE_PIN R10 [get_ports nextbtn]						
...
set_property PACKAGE_PIN B13 [get_ports {rgb1[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {rgb1[2]}]
#Bank = 15, Pin name = IO_L5N_T0_AD9N_15,					Sch name = JA2
set_property PACKAGE_PIN F14 [get_ports {rgb1[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {rgb1[1]}]
#Bank = 15, Pin name = IO_L16N_T2_A27_15,					Sch name = JA3
set_property PACKAGE_PIN D17 [get_ports {rgb1[0]}]					
...
set_property PACKAGE_PIN G14 [get_ports {disp_row[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {disp_row[0]}]
#Bank = 14, Pin name = IO_L13P_T2_MRCC_14,					Sch name = JB2
set_property PACKAGE_PIN P15 [get_ports {disp_row[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {disp_row[1]}]
#Bank = 14, Pin name = IO_L21N_T3_DQS_A06_D22_14,			Sch name = JB3
set_property PACKAGE_PIN V11 [get_ports {disp_row[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {disp_row[2]}]
...
set_property PACKAGE_PIN T9 [get_ports {lat}]					
...
set_property PACKAGE_PIN K2 [get_ports {sclk_s}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sclk_s}]
#Bank = 35, Pin name = IO_L6P_T0_35,						Sch name = JC2
set_property PACKAGE_PIN E7 [get_ports {blank_s}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {blank_s}]
#Bank = 35, Pin name = IO_L22P_T3_35,						Sch name = JC3
set_property PACKAGE_PIN J3 [get_ports {lat_s}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {lat_s}]
#Bank = 35, Pin name = IO_L21P_T3_DQS_35,					Sch name = JC4
set_property PACKAGE_PIN J4 [get_ports {trig_s}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {trig_s}]
